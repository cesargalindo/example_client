 ...
 * @returns {Blob}
 */
CGMeteorCamera.dataURItoFile = function (dataURI, fileName) {
    var blob = CGMeteorCamera.dataURItoBlob(dataURI);
    var file = CGMeteorCamera.blobToFile(blob, fileName);
    return file;
}
 ...
 */
CGMeteorCamera.dataURItoBlob = function (dataURI) {
    var byteString = '';
 ...
 */ 
CGMeteorCamera.blobToFile = function (blob, fileName) {
