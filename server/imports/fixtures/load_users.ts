...
export function loadUsers() {
    ...
    if (Meteor.users.find().count() === 0) {
        ...
        addUserDelayed('0000000012', 'samg@zojab.com', 'mutilo11', '', 19);
        addUserDelayed('0000000209', 'avag@zojab.com', 'mutilo11', '', 20);
        addUserDelayed('0000000210', 'barbg@zojab.com', 'mutilo11', '', 21);
