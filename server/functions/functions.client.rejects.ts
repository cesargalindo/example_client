...
export function rejectPriceProcess(rp1: RequestPriceProcess) {
    ...
    console.log('========= requestpricesQueue.reject ======1====' + rp1.id + ' -- ' + requestPrices.owner);
