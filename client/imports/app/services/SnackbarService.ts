...
export class SnackbarService {
    ...
    public displaySnackbar(message) {
        ...
        if (message == 1) {
            ...
            this.snackBar.open('Thanks! Your request has been submitted.', 'Dismiss', { duration: 3000});
            this.snackbar_set = true;
        }
        else if (message == 5) {
            this.snackBar.open( 'You are out of requests. Please purchse more.', 'Dismiss', { duration: 4000});
            this.snackbar_set = true;
        }
