...
import { ReactiveMapComponent } from './reactive-map/reactive-map';
...
@NgModule({
    ...
    declarations: [ ReactiveMapComponent, PlacesAutocompleteComponent ],
    exports: [ ReactiveMapComponent,PlacesAutocompleteComponent ]
})
